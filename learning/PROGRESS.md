...
- **当前天数**: Day 5 进行中（Img2Img + Inpainting 完成，Outpainting 完成）
- **上次学习时间**: 2026-03-20 16:03 UTC
- **累计学习轮数**: 11
...
- [ ] ControlNet 基础原理
  - [ ] ControlNet 架构（零卷积、权重注入方式）
  - [ ] Preprocessor 与 ControlNet 模型的关系
- [ ] Canny / Depth / Pose 三大经典 ControlNet
  - [ ] 每种的最佳使用场景
  - [ ] preprocessor 参数调优
